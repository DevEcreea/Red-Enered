...
export default function SubsidioPublico() {
  ...
  // Un cliente REAL ya logueado va directo a su Mi Flota (el invitado sí puede consultar).
  ...
  async function consultar() {
    ...
    try {
      // Sesión INVITADA: entra a la plataforma (Mi Flota · Etapa 0) SIN crear usuario en la BD.
