...
const MENU = [
  ...
  { to: "/calendario", label: "Calendario", icon: Calendar, roles: ["admin_enered", "administrador", "logistica", "contabilidad"], testid: "nav-calendario", badge: "NUEVO", badgeColor: "amber" },
  { to: "/tickets", label: "Tickets", icon: Ticket, roles: ["admin_enered", "administrador", "logistica", "contabilidad"], testid: "nav-tickets", badge: "NUEVO", badgeColor: "amber" },
  ...
  { to: "/checklist", label: "Checklist", icon: ClipboardCheck, roles: ["admin_enered", "administrador", "logistica", "contabilidad"], testid: "nav-checklist", badge: "NUEVO", badgeColor: "amber"},
  ...
  { to: "/vehiculos", label: "Vehículos", icon: Car, roles: ["admin_enered", "administrador", "logistica", "contabilidad"], testid: "nav-vehiculos", badge: "NUEVO", badgeColor: "amber" },
  ...
  { to: "/viajes", label: "Viajes", icon: Route, roles: ["admin_enered", "administrador", "logistica", "contabilidad"], testid: "nav-viajes", badge: "NUEVO", badgeColor: "amber" },
