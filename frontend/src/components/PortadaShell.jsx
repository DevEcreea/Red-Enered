...
/**
 * Cascarón de la portada ENERED: lado oscuro con el anillo de módulos (idéntico en
 * /subsidio y /login) + panel claro a la derecha cuyo contenido llega por children.
 */
export default function PortadaShell({ children }) {
